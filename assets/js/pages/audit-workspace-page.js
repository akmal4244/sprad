 ...
 * Update Info: 2026-06-20 - Ringkaskan fallback sidebar workspace audit kepada menu penting.
 */
    ...
    <main class="sprad-shell mx-auto grid w-full max-w-7xl gap-4 px-4 py-4 sm:px-6 lg:grid-cols-[18rem_minmax(0,1fr)] lg:px-8">
      <aside class="sprad-sidebar self-start lg:sticky lg:top-16">
        ...
        <div class="mt-4 space-y-2">
          ...
          <p class="px-4 pt-4 text-[11px] font-extrabold uppercase tracking-widest text-slate-400">Pentadbir</p>
