  ...
  document.body.innerHTML = `
    ...
    <main class="mx-auto grid w-full max-w-7xl gap-4 px-4 py-4 sm:px-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:px-8">
      ...
      <section class="grid content-start gap-5">
        ...
        <div class="grid gap-4 md:grid-cols-5"><div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-extrabold uppercase tracking-widest text-slate-400">Dijana</p><strong id="generatedAt" class="mt-3 block text-sm text-slate-900">-</strong></div><div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-extrabold uppercase tracking-widest text-slate-400">Penemuan</p><strong id="totalFindings" class="mt-3 block text-3xl text-slate-900">0</strong></div><div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-extrabold uppercase tracking-widest text-slate-400">Tahap</p><strong id="overallLevel" class="mt-3 block text-2xl text-blue-700">-</strong></div><div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-extrabold uppercase tracking-widest text-slate-400">Lewat</p><strong id="overdueActions" class="mt-3 block text-3xl text-red-700">0</strong></div><div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm"><p class="text-xs font-extrabold uppercase tracking-widest text-slate-400">Pengesahan</p><strong id="awaitingVerification" class="mt-3 block text-3xl text-amber-700">0</strong><small id="cacheStatus" class="mt-2 block text-xs font-bold text-slate-400">-</small></div></div>
