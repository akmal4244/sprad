...
function ensureShell() {
  ...
  document.querySelectorAll("card").forEach(card => {
    card.outerHTML = `<div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">${card.innerHTML}</div>`;
  });
}
